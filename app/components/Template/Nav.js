...
const Nav = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>David Roth</h2>
        <p><a href="mailto:davidroth6@gmail.com">davidroth6@gmail.com</a></p>
      </header>
    </section>
    ...
    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m David.
        I am a <a href="https://icme.stanford.edu/">NYU</a> graduate, YC Alumni, and
    ...
    <section id="footer">
      ...
      <p className="copyright">&copy; David Roth <Link to="/">mldangelo.com</Link>.</p>
    </section>
  </section>
);
